...
class KafkaBaseMonitor(BaseMonitor):
    ...
    def _create_producer(self, settings):
        ...
        try:
            ...
            self.logger.error(
                "Couldn't initialize kafka producer in plugin.",
    ...
    def _send_to_kafka(self, master):
        ...
        firehose_topic = "{prefix}.outbound_firehose".format(prefix=self.topic_prefix)
        try:
            ...
            message = (
                "An exception '{0}' occured while sending a message "
