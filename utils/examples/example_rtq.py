...
def main():
    ...
    parser.add_argument(
        "-r", "--redis-host", action="store", required=True, help="The Redis host ip"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-w", "--window", action="store", default=60, help="The window time to test"
    )
    parser.add_argument(
        "-n",
        "--num-hits",
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="Test variable elastic catch up" " with moderation",
    )
