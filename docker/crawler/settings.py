...
KAFKA_PRODUCER_BUFFER_BYTES = int(
    os.getenv("KAFKA_PRODUCER_BUFFER_BYTES", 4 * 1024 * 1024)
)  # 4MB before blocking
KAFKA_PRODUCER_MAX_REQUEST_SIZE = int(
    os.getenv("KAFKA_PRODUCER_MAX_REQUEST_SIZE", 1024 * 1024)
)  # 1MB
